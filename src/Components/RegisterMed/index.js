...
import {DropOptions, RegisterContainer} from './styles';
...
<DropOptions icon={User}>
    <option value='' disabled hidden selected style={{'color':'gray','background':'lightgray'}}>Sexo</option>
    <option value='choice'>Masculino</option>
